  ...
  Annotate.prototype = {
    init: function() {
      ...
      if (self.options.bootstrap) {
        ...
        self.$tool += '<label  class="getcolor btn btn-primary" data-datac="red";  style="background: red !important;padding: 6px;">Red</label>'+
      	'<label class="getcolor btn btn-primary" data-datac="blue"; style="background: blue !important;padding: 6px;">Blue</label>'+
      	'<label class="getcolor btn btn-primary" data-datac="green"; style="background: green !important;padding: 6px;">Green</label> <label class="btn btn-primary active">' +
          '<input type="radio" name="' + self.toolOptionId +
          '" data-tool="rectangle"' +
          ' data-toggle="tooltip" data-placement="top"' +
      ...
      self.$textbox = $('<textarea id=""' +
        ...
        ';font-family:sans-serif;color:' + window.color +
    ...
    redraw: function() {
      ...
      //self.baseContext.strokeStyle = window.color;
        ...
        switch (element.type) {
          ...
          case 'pen':
            ...
            for (var b = 0; b < element.points.length - 1; b++) {
              ...
              self.drawPen(self.baseContext, fromx, fromy, tox, toy,i);
            }
            break;
          case 'text':
          console.log(element);
    ...
    drawRectangle: function(context, x, y, w, h,selfcolor) {
      ...
      context.strokeStyle = selfcolor;
      context.stroke();
    },
    drawCircle: function(context, x1, y1, x2, y2,selfcolor) {
    ...
    drawArrow: function(context, x, y, w, h,selfcolor) {
      var self = this;
    ...
    drawPen: function(context, fromx, fromy, tox, toy,drawPen_selfcolor) {
      var self = this;
      context.lineWidth = self.linewidth;
      context.moveTo(fromx, fromy);
      context.lineTo(tox, toy);
      context.strokeStyle = drawPen_selfcolor;
    ...
    drawText: function(context, text, x, y, maxWidth,selfcolor) {
      var self = this;
      context.font = self.fontsize + ' sans-serif';
      context.textBaseline = 'top';
      context.fillStyle = selfcolor;
    ...
    annotatemove: function(event) {
      ...
      switch (self.options.type) {
        ...
        case 'circle':
          ...
          self.tox = (pageX - offset.left) * self.compensationWidthRate;
          self.toy = (pageY - offset.top) * self.compensationWidthRate;
          self.drawCircle(self.drawingContext, self.fromx, self.fromy,self.tox, self.toy,window.color);
          break;
        default:
      }
    },
