...
<?php if(canaccess("amc_device","view_access") != 'true'){ echo "<script>window.location.href ='".site_url()."admin'</script>";}?>
		...
		<div class="row">
	        <div class="col-sm-12">
	            <div class="pull-right">
	            	...
	            	<?php if(canaccess("amc_device","create_access")) { ?> 
	            	...
	            	<a href="<?= base_url("admin/amc_device"); ?>/unset_session_value" id="unset_button"><button type="button" class="btn btn-primary m-r-5" status="none"><span class="glyphicon glyphicon-refresh"></span></button></a>	
	            </div>
		      ...
		      <div class="panel panel-default">
		         <div class="panel-body">
		            <div class="fixed-table-toolbar">
		               <form autocomplete="off" name="searchfrom" id="searchfrom" method="post"  action='<?= base_url("admin/amc_device"); ?>' enctype="multipart/form-data">
            		  ...
            		  <?php $count = 1; 
                			...
                			foreach ($rows as $row) : ?>
	        					<tr>
									...
									<td>
								<?php if(canaccess("amc_device","edit_access")){ ?>
								 <a href='<?= base_url("admin/amc_device/edit/{$row['id']}"); ?>'><button class="btn btn-icon btn-xs waves-effect waves-light btn-purple" data-toggle="tooltip" data-placement="left" title="" data-original-title="<?= lang('edit'); ?>"> <i class="fa fa-edit"></i> </button></a>
								<?php } ?>
								<?php if(canaccess("amc_device","delete_access")){ ?>
...
<script>
	...
	$(document).ready(function() {
		$('#row_add').on('submit',function(e) {
			...
			$.ajax({
				url: "<?php echo site_url('admin/amc_device/add_row')?>/",
				type: "POST",
        ...
        $('.sa-params').click(function () {
            ...
            swal({
            	...
            	$.ajax({
            		type: "POST",
            		url: "<?php echo site_url('admin/amc_device/row_delete')?>/"+id,
