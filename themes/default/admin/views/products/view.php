		            ...
		            <div class="fixed-table-toolbar">
		               <form name="searchfrom" id="searchfrom" method="post"  action='<?= base_url("admin/products"); ?>' enctype="multipart/form-data">
		                  ...
		                  <div class="pull-left search margin m-r-15">
		                     <div class="searchdatetitle">Products code</div>
		                     <input class="form-control" type="text" placeholder="Any Text.." name="products_s_product_code" id="products_s_product_name" value="<?= (isset($_REQUEST['products_s_product_code']) ? $_REQUEST['products_s_product_name'] : '');?><?php if(isset($_REQUEST['products_s_product_code'])) 
                              { 
                                echo $_REQUEST['products_s_product_code']; 
                              } 
                              else 
                              { 
                                if($this->session->userdata('products_s_product_code')) 
                                { 
                                  echo $this->session->userdata('products_s_product_code'); 
                                } 
                              }
                      ?>">
		                  </div>
                      ...
                      ?>">
		                  ...
		                  <div class="pull-left search margin m-r-15">
		                     <div class="searchdatetitle">HSN Code</div>
	...
	<tbody>
		<?php if(!empty($rows)) {  ?>
          ...
          <td><?= $row['product_code']; ?></td>
				  ...
				  <td><?= $this->sam->get_real_value('zyd_product_brand','id',$row['brand_id'],'title') ?></td>
          <td><?= $this->sam->get_real_value('zyd_product_category','id',$row['category_ids'],'title') ?></td>
          <td><i class="fa fa-inr" ></i><?= number_format($row['price']); ?></td>
        ...
        <div class="modal-content">
        	<form name="add_row" id="add_row" method="post" enctype="multipart/form-data">
	            ...
	            <div class="modal-body">
                  ...
                  <div class="col-md-4">
                        <div class="form-group">
                        <label for="fabric_type">Product Category</label>
                        <select data-live-search="true" name="category_ids" id="category_ids" class="selectpicker form-control attribute_get" data-style="btn-white" >
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                        <label for="fabric_type">Product Brand</label>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" required="required" name="price" id="price" class="form-control" placeholder="price">
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" name="purchased_price" id="purchased_price" class="form-control" placeholder="Purchase price">
                        </div>
                    </div>
      ...
      showTinymic('#description');
		...
		$('#add_row').on('submit',function(e) {
           ...
           tinyMCE.triggerSave();
			...
			if($('#product_code').val() == '' || $('#product_name').val() == '' || $('#price').val() == '' ) {
				return false;
			}
