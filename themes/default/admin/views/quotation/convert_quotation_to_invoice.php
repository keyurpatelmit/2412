        ...
        <div class="panel panel-color panel-inverse">
             ...
             <div class="row">   
                <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input readonly="" type="text" name="invoice_no" id="invoice_no" class="form-control" value="<?= $auto_invoice_no ?>">
                        </div>
                </div>
            </div>
            ...
            <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" name="inquery_date" id="inquery_date" class="form-control datepicker-autoclose" required="required" value="<?= $this->maahi->date_format($row->quotation_date); ?>">
                    </div>
            </div>
