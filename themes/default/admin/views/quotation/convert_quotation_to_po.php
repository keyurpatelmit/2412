    ...
    <div class="col-lg-12">
             ...
             <div class="row">   
                <div class="col-md-3">
                    <div class="form-group">
                        <label for="quotation_subject">Purchase Order No <span class="text-danger">*</span></label>
                        <input readonly="" type="text" name="purchase_no" id="purchase_no" class="form-control" value="<?= $auto_invoice_no ?>">
                    </div>
                </div>
                <div class="col-md-3">
                        <div class="form-group">
        ...
        <?php $randno = rand(); ?>
                ...
                <tr>
                    ...
                    <td><input type="text" name="item_description[]" id="item_description" class="form-control item_description"></td>
           ...
           $('#row_add').on('submit',function(e) {
            ...
            $.ajax({
                ...
                success: function() {
                    ...
                    setTimeout(function() {
                       window.location = "<?= base_url('admin/puchaseorder') ?>";
                    },1000);
                },
                error: function() {
...
function add_inquiry_item()
{
    ...
    $('#inquiry_list_ui').append('<tr id="forcontactrow">'+
            ...
            '<td><input type="text" name="purchase_item_price[]" id="purchase_item_price_'+randno+'" class="form-control" onkeyup="get_item_total('+randno+')"></td>'+
             '<td><input type="text" name="margin_item_price[]" id="margin_item_price_'+randno+'" class="form-control total_margin_item_price"></td>'+
            '<td><input type="text" name="item_description[]" id="item_description" class="form-control"></td>'+
            '<td><input type="text" name="item_remark[]" id="item_remark" class="form-control"></td>'+
            '<td>'+
