		...
		<div class="row">
	        <div class="col-sm-12">
	            ...
	            <div class="pull-right">
	            	...
	            	<?php if(canaccess("quotation","create_access")) { ?> 
	            	<a onclick="formSubmit('excel')" href="<?= base_url("admin/quotation/add_quotation"); ?>" id="unset_button"><button type="button" id="add" class="btn btn-purple waves-effect waves-light">Add New</button></a>
	            	...
	            	<a href="<?= base_url("admin/quotation"); ?>/unset_session_value" id="unset_button"><button type="button" class="btn btn-primary m-r-5" status="none"><span class="glyphicon glyphicon-refresh"></span></button></a>	
	            </div>
            ...
            <div class="col-sm-12 card-box" >
                 <div class="table-responsive" data-pattern="priority-columns">
                	...
                	<thead>
                		...
                		<th><?= lang('Status'); ?></th>
                		<!-- <th><?= lang('Puchase order'); ?></th>
                		<th><?= lang('Sales order'); ?></th> -->
                		<!-- <th><?= lang('Challan'); ?></th> -->
                		...
                		<?php if(!empty($rows)) { ?>
            		  	<?php $count = 1; 
                			...
                			foreach ($rows as $row) : ?>
								...
								<!-- <td>
									 <a href='<?= base_url("admin/quotation/convert_quotation_to_po/{$row['id']}"); ?>'><button class="btn btn-icon btn-xs waves-effect waves-light btn-purple" data-toggle="tooltip" data-placement="left" title="" data-original-title="<?= lang('Puchase order'); ?>">PO </button></a>
								</td>


								<td>
									<a href='<?= base_url("admin/quotation/sales/{$row['id']}"); ?>'><button class="btn btn-icon btn-xs waves-effect waves-light btn-purple" data-toggle="tooltip" data-placement="left" title="" data-original-title="<?= lang('sales'); ?>"> <i class="fa fa-edit"></i> Sales</button></a>
								</td>

								<td>
									 <a href='<?= base_url("admin/quotation/Challan/{$row['id']}"); ?>'><button class="btn btn-icon btn-xs waves-effect waves-light btn-purple" data-toggle="tooltip" data-placement="left" title="" data-original-title="<?= lang('Puchase order'); ?>">Challan </button></a>
								</td> -->
								<td>
								<?php $checkConv =  $this->sam->check_quotation_converted($row['id']);  ?>
								<?php if(!$checkConv) { ?>
								 <a href='<?= base_url("admin/quotation/convert_quotation_to_invoice/{$row['id']}"); ?>'><button class="btn btn-icon btn-xs waves-effect waves-light btn-purple" data-toggle="tooltip" data-placement="left" title="" data-original-title="<?= lang('Create Invoice'); ?>">Create Invoice </button></a>
								<?php }else{ ?>
									<a href='javascript:void();'><button class="btn btn-icon btn-xs waves-effect waves-light btn-default" data-toggle="tooltip" data-placement="left" title="" data-original-title="<?= lang('Created'); ?>">Created</button></a>
								<?php } ?>


								 <!-- <a href='<?= base_url("admin/quotation/revise_quotation/{$row['id']}"); ?>'><button class="btn btn-icon btn-xs waves-effect waves-light btn-default" data-toggle="tooltip" data-placement="left" title="" data-original-title="<?= lang('Revise'); ?>">Revise </button></a> -->

								<a target="blank" href='<?= base_url("admin/quotation/quotation_pdf/{$row['id']}"); ?>'><button class="btn btn-icon btn-xs waves-effect waves-light btn-info" data-toggle="tooltip" data-placement="left" title="" data-original-title="<?= lang('Quotation_Pdf'); ?>"> <i class="fa fa-file-pdf-o"></i> </button></a>

								<?php if(canaccess("quotation","edit_access")){ ?>
								 <a href='<?= base_url("admin/quotation/edit/{$row['id']}"); ?>'><button class="btn btn-icon btn-xs waves-effect waves-light btn-purple" data-toggle="tooltip" data-placement="left" title="" data-original-title="<?= lang('edit'); ?>"> <i class="fa fa-edit"></i> </button></a>
								<?php } ?>

								<?php if(canaccess("quotation","delete_access")){ ?>
					...
					<?php } else { ?>
						<tr class="text-center">
							<td colspan="11" ><?= $no_record_txt ?></td>
						</tr>
					<?php }  ?>
