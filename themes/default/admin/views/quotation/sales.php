...
<div class="row">
    <div class="col-lg-12">
        <div class="panel panel-color panel-inverse">
             ...
             <div class="row">   
                <div class="col-md-3">
                    <div class="form-group">
                        <label for="sales_order_no">Sales Order No <span class="text-danger">*</span></label>
                        <input readonly="" type="text" name="sales_order_no" id="sales_order_no" class="form-control" value="<?= $auto_invoice_no ?>">
                    </div>
                </div>

                <div class="col-md-3">
                    <div class="form-group">
                        <label for="po_no">Purchase order No <span class="text-danger">*</span></label>
                ...
                <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input readonly="" type="hidden" name="quotation_id" id="quotation_id" class="form-control" value="<?= $row->quotation_id ?>">
                        </div>
                </div>
            </div>
            ...
            <div class="col-md-3">
                <div class="form-group">
                    <label for="name">Inquiry source</label>
            ...
            <div class="col-md-3">
                    <div class="form-group">
                        <label for="name">Sales Order date <span class="text-danger">*</span></label>
                        <input type="text" name="sales_order_date" id="sales_order_date" class="form-control datepicker-autoclose" required="required" value="<?= $this->maahi->date_format($row->quotation_date); ?>">
                    </div>
            </div>
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <input type="text" name="delivery_note" id="delivery_note" class="form-control" >
                </div>
            </div>
               ...
               <div class="col-md-3">
                <div class="form-group">
                    ...
                    <input type="text" name="shipping_address_pdf" id="shipping_address_pdf" class="form-control" >
                </div>
            </div>
        ...
        <?php if (!empty($inquiry_items)): ?>
            ...
            <tr id="remove_item_ui_<?= $inquiry_item['id'] ?>">
                ...
                <td><input type="text total_count" name="item_price[]" id="item_price_<?= $randno ?>" class="form-control " onkeyup="get_item_total(<?= $randno ?>)" value="<?= $inquiry_item['item_price'] ?>">
                
                <input type="hidden" name="item_gst[]" id="item_gst_<?= $randno ?>" class="form-control" value="<?= @$inquiry_item['item_gst'] ?>">
                ...
                <td><input type="text" name="purchase_item_price[]" id="purchase_item_price_<?= $randno ?>" class="form-control" value="<?= $inquiry_item['purchase_item_price'] ?>" onkeyup="get_item_total(<?= $randno ?>)"></td>

                <td><input type="text" name="margin_item_price[]"  id="margin_item_price_<?= $randno ?>" class="form-control total_margin_item_price" value="<?= $inquiry_item['margin_item_price'] ?>"></td>
                ...
                <td><input type="text"  name="edit_item_remark[]" id="item_remark" class="form-control" value="<?= $inquiry_item['item_remark'] ?>"></td>
                <td>
        ...
        <?php $randno = rand(); ?>
                ...
                <tr>
                    ...
                    <td><button onclick="add_inquiry_item()" class="btn btn-success" type="button"><i class="fa fa-plus-circle"></i> </button>
                    </td>
                </tr>
            </tbody>
            <tr>
         ...
         <table class="table">
            ...
            <tbody id="term_condition_ui">
                ...
                <tr id="remove_quotation_terms_row_<?= $quotation_term['id'] ?>">
                    ...
                    <td>
                        <textarea name="term_condition_txt[]" id="term_condition_txt_<?= $randno ?>" class="form-control term_condition_txt"><?= $quotation_term['item_description'] ?></textarea>
                    </td>
                     <td>
    ...
    $(document).ready(function() {
           ...
           $('#row_add').on('submit',function(e) {
            ...
            $.ajax({
                url: "<?php echo site_url('admin/quotation/add_sales_order')?>/",
                type: "POST",
                ...
                success: function() {
                    ...
                    setTimeout(function() {
                       window.location = "<?= base_url('admin/salesorder') ?>";
                    },1000);
                },
                error: function() {
