...
<div class="row">
    <div class="col-lg-12">
        <div class="panel panel-color panel-inverse">
            ...
            <form method="post" enctype="multipart/form-data" name="row_add" id="row_add"  action='<?= base_url("admin/quotation/edit/{$row->id}"); ?>'>
             ...
             <div class="row">   
                ...
                <div class="col-md-9">
                    <div class="form-group">
                        ...
                        <input type="text" name="quotation_subject" id="quotation_subject" class="form-control" required="required" value="<?= $row->quotation_subject; ?>">
                    </div>
            </div>
            </div>
 ...
 -->
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <select  data-live-search="true" name="customer_id" id="customer_id" class="selectpicker form-control"  data-style="btn-white" required="required">
                        ...
                        <option <?php if($row->customer_id == $customer['id']) { echo "selected"; }  ?> data-customer_state_id="<?= $customer['state_id']?>" value="<?= $customer['id']; ?>"><?= $customer['name']; ?></option>   
                        <?php endforeach ?>
                    </select>
                </div>
            </div>
            ...
            <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" name="quotation_date" id="quotation_date" class="form-control datepicker-autoclose" required="required" value="<?= $this->maahi->date_format($row->quotation_date); ?>">
                    </div>
            </div>
            ...
            <label for="contact_email">Inquiry status</label>
             ...
             <div class="col-md-3">
                <div class="form-group">
                    ...
                    <input type="date" name="valid_till" id="valid_till" class="form-control" value="<?= $row->valid_till  ?>">
                </div>
            </div>
            <div class="col-md-3">
                <div class="form-group">
                    <label for="contact_email">Reference</label>
                    <input type="text" name="reference" id="reference" class="form-control" value="<?= $row->reference ?>">
                </div>
            </div>
        ...
        <?php if (!empty($inquiry_items)): ?>
            ...
            <tr id="remove_item_ui_<?= $inquiry_item['id'] ?>">
                <td>
                 ...
                 <td><input type="text" name="edit_item_tax[]" id="item_tax_<?= $randno ?>" class="form-control" onkeyup="get_item_total(<?= $randno ?>)" value="<?= @$inquiry_item['item_tax'] ?>"></td>
                <td><input type="text total_count" name="edit_item_rate[]" id="item_rate_<?= $randno ?>" class="form-control " onkeyup="get_item_total(<?= $randno ?>)" value="<?= $inquiry_item['item_rate'] ?>">
                ...
                <td><input type="text" name="edit_item_amount[]" id="item_amount_<?= $randno ?>" class="form-control" value="<?= $inquiry_item['item_amount'] ?>" onkeyup="get_item_total(<?= $randno ?>)"></td>
                <td class="igst"><input type="text" name="edit_item_igst[]" id="item_igst_<?= $randno ?>" class="form-control" value="<?= $inquiry_item['item_igst'] ?>" onkeyup="get_item_total(<?= $randno ?>)"></td>
                <td class="cgst"><input type="text" name="edit_item_cgst[]" id="item_cgst_<?= $randno ?>" class="form-control" value="<?= $inquiry_item['item_cgst'] ?>" onkeyup="get_item_total(<?= $randno ?>)"></td>
                <td  class="sgst"><input type="text" name="edit_item_sgst[]" id="item_sgst_<?= $randno ?>" class="form-control" value="<?= $inquiry_item['item_sgst'] ?>" onkeyup="get_item_total(<?= $randno ?>)"></td>

                <td><input type="text" name="edit_item_final_total[]"  id="item_final_total_<?= $randno ?>" class="form-control total_margin_item_price" value="<?= $inquiry_item['item_final_total'] ?>"></td>
                     ...
                     <td>
                        <div class="hide" id="item_service_ui_<?= $randno ?>">
                            <select data-live-search="true" class="selectpicker form-control" name="item_service[]" id="item_service_<?= $randno ?>" data-style="btn-white" onchange="get_item_price_services(<?= $randno ?>)">
                                <option value="">Select Serivce</option>
                                <?php foreach ($services as $key => $service): ?>
                                <option data-sid="<?= $service['id'] ?>" data-gst="<?= $service['gst'] ?>" data-price="<?= $service['price'] ?>" value="<?= $service['id'] ?>"><?= $service['title'] ?></option>  
                                <?php endforeach ?>     
                            </select>
                        </div>
                         ...
                         <div class="hide" id="item_product_ui_<?= $randno ?>">
                              <select data-live-search="true" class="selectpicker form-control" name="item_product[]" id="item_product_<?= $randno ?>" data-style="btn-white" onchange="get_item_price_product(<?= $randno ?>)">
                                <option value="">Select products</option>
                                <?php foreach ($products as $key => $product): ?>
                                    <option data-purchased_price="<?= $product['purchased_price'] ?>" data-pid="<?= $product['id'] ?>" data-price="<?= $product['price'] ?>" data-gst="<?= $product['gst'] ?>"value="<?= $product['id'] ?>"><?= $product['product_name'] ?></option>  
                                <?php endforeach ?>    
                            </select>
                         </div>
                    </td>
      ...
      <table class="table">
            ...
            <tbody id="term_condition_ui">
                ...
                <?php $randno = rand(); ?>
                <tr id="remove_quotation_terms_row_<?= $quotation_term['id'] ?>">
                    <td>
    ...
    $(document).ready(function() {
        ...
        $('.sa-params-terms').click(function () {
            ...
            swal({
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo site_url('admin/quotation/remove_quotation_terms')?>/"+id,
