...
<div class="row">
    <div class="col-lg-12">
        <div class="panel panel-color panel-inverse">
            ...
            <div class="row">   
                <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input readonly="" type="text" name="challan_no" id="challan_no" class="form-control" value="<?= $auto_quotation_no ?>">
                        </div>
                </div>
                <div class="col-md-3">
                        <div class="form-group">
            ...
            <div class="col-md-3">
                    <div class="form-group">
                        <label for="name">Challan date <span class="text-danger">*</span></label>
            ...
            <label for="contact_email">Temporary status</label>
                <select class="form-control" name="temporary_status" id="temporary_status" >
                    <option value="">Select status</option>
                    <option <?php if($row->status == 'given') { echo "selected"; }  ?> value="given">Given</option>
                    <option <?php if($row->status == 'received') { echo "selected"; }  ?> value="received">Received</option>
                </select>
            </div>
            </div>
        ...
        <div class="row">
            ...
            <tr id="remove_item_ui_<?= $inquiry_item['id'] ?>">
                <td>
                 ...
                 <td><input type="text" name="item_qty[]" id="item_qty_<?= $randno ?>" class="form-control" onkeyup="get_item_total(<?= $randno ?>)" value="<?= $inquiry_item['item_qty'] ?>">
                 </td>
                <td>
    ...
    $(document).ready(function() {
        ...
        showTinymic_small('.item_description');
           ...
           $('#row_add').on('submit',function(e) {
            ...
            $.ajax({
                url: "<?php echo site_url('admin/quotation/add_challan')?>/",
                type: "POST",
