                ...
                <div class="card-box">
                    <div class="bar-widget">
                        <div class="table-box">
                            ...
                            <div class="table-detail">
                               <h4 class="m-t-0 m-b-5"><b><a href="<?= base_url('admin/inquiry'); ?>" ><?= $inquiry; ?></a></b></h4>
                               <p class="text-muted m-b-0 m-t-0">Inquiry</p>
                            </div>
                            <div class="table-detail text-right">
                                <span data-plugin="peity-donut" data-colors="#34d3eb,#ebeff2" data-width="50" data-height="45"><?= $inquiry; ?>/100</span>
                            </div>
                ...
                <div class="card-box">
                    <div class="bar-widget">
                        <div class="table-box">
                            ...
                            <div class="table-detail">
                               <h4 class="m-t-0 m-b-5"><b><a href="<?= base_url('admin/quotation'); ?>" ><?= $quotation; ?></a></b></h4>
                               <p class="text-muted m-b-0 m-t-0">Quotation</p>
                            </div>
                            <div class="table-detail text-right">
                                <span data-plugin="peity-donut" data-colors="#34d3eb,#ebeff2" data-width="50" data-height="45"><?= $quotation; ?>/100</span>
                            </div>
