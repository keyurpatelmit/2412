...
<?php if(canaccess("expense_category","edit_access") != 'true'){ echo "<script>window.location.href ='".site_url()."admin'</script>";}?>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="panel panel-color panel-inverse">
                    ...
                    <form method="post"  action='<?= base_url("admin/expense_category/edit/{$row->id}"); ?>' enctype="multipart/form-data">
