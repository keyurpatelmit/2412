        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="panel panel-color panel-inverse">
                    ...
                    <form name="services_edit" id="services_edit" method="post"  action='<?= base_url("admin/documents/edit/{$row->id}"); ?>' enctype="multipart/form-data">
              ...
              <div class="row">
                    ...
                    <div class="col-md-6">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="hsn_code" id="hsn_code" class="form-control" placeholder="service Name" value="<?=  $row->hsn_code; ?>">
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="gst" id="gst" class="form-control" placeholder="service Name" value="<?=  $row->gst; ?>">
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" required="required" name="price" id="price" class="form-control" placeholder="service Price" value="<?=  $row->price; ?>">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="description" id="description" required="required"><?= $row->description;?></textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="panel-footer">
                        ...
                        <div class="clearfix">
                            ...
                            <a href="<?= base_url('admin/documents'); ?>"><button type="button" class="btn btn-inverse waves-effect waves-light pull-right" data-dismiss="modal" aria-hidden="true">Close</button></a>
                        </div>
                    </div>
                </form>
                </div>
