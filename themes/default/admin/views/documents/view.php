	        ...
	        <div class="col-sm-12">
	            ...
	            <div class="pull-right"> 
	            	...
	            	<a onclick="formSubmit('excel')" href="javascript:void();" id="unset_button"><button type="button" class="btn btn-default" status="none"><span class="glyphicon glyphicon-download-alt"></span> Export</button></a>
	            		<?php } ?>		
	            	<a href="<?= base_url("admin/documents"); ?>/unset_session_value" id="unset_button"><button type="button" class="btn btn-primary m-r-5" status="none"><span class="glyphicon glyphicon-refresh"></span></button></a>	
	            </div>
		      	...
		      	<div class="panel panel-default">
		         	<div class="panel-body">
		            	<div class="fixed-table-toolbar">
		               		<form autocomplete="off" name="searchfrom" id="searchfrom" method="post"  action='<?= base_url("admin/documents"); ?>' enctype="multipart/form-data">
        			...
        			<?php 
        				...
        				{  ?>
    						...
    						<tr>
							    ...
							    <td>
							    	<?php if ($row['image'] != ''){ ?>
									<img class="img-circle tbl_img" src="<?= base_url() ?>themes/default/admin/assets/images/comman_image/<?= $row['image']; ?>" alt="" style="width: 60px; height: 60px; border-radius: 50%; object-fit: cover; border: 2px solid #ddd;  ">
								<?php  } ?> </td>
								...
								<td>
						 			...
						 			<a href='<?= base_url("admin/documents/edit/{$row['id']}"); ?>'><button class="btn btn-icon btn-xs waves-effect waves-light btn-purple" data-toggle="tooltip" data-placement="left" title="" data-original-title="<?= lang('edit'); ?>"> <i class="fa fa-edit"></i> </button></a>
						 			<?php } ?>
	              			...
	              			<div class="row">
	              				...
	              				<div class="col-md-12">
	              					<div class="form-group">
	              						...
	              						<input type="file" required="required" name="image" id="image" class="form-control">
	              					</div>
	              				</div>
...
<script>
	...
	$(document).ready(function() {
		...
		$('#add_form').on('submit',function(e) {
			...
			$.ajax({
				url: "<?php echo site_url('admin/documents/add_row')?>/",
				type: "POST",
        ...
        $('.sa-params').click(function () {
            ...
            swal({
            	...
            	$.ajax({
            		type: "POST",
            		url: "<?php echo site_url('admin/documents/row_delete')?>/"+id,
