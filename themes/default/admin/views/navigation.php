...
?>
   ...
   <div class="navbar-custom">
    ...
    <!-- <?php if(canaccess("vendor","view_access")) { ?> 
        <li><a href="<?= base_url('admin/vendor'); ?>"><i class="fa fa-users"></i><?= lang('Contract'); ?></a></li>
    <?php } ?> -->
     ...
     <li class="has-submenu">
       ...
       <li class="has-submenu">
        ...
        <ul class="submenu">
            ...
            <?php } ?> 
            <?php if(canaccess("inquiry_source","view_access")) { ?> 
                <li><a href="<?= base_url('admin/inquiry_source'); ?>"><?= lang('Inquiry_source'); ?></a></li>
            <?php } ?>
