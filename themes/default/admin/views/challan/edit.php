...
<div class="row">
    <div class="col-lg-12">
        <div class="panel panel-color panel-inverse">
            ...
            <form method="post" enctype="multipart/form-data" name="row_add" id="row_add"  action='<?= base_url("admin/challan/edit/{$row->id}"); ?>'>
             ...
             <div class="row">  
              <div class="col-md-3">
                        <div class="form-group">
                            <label for="quotation_subject">Challan No <span class="text-danger">*</span></label>
                            <input readonly="" type="text" name="challan_no" id="challan_no" class="form-control" value="<?= $row->challan_no ?>">
                        </div>
                </div> 
                <div class="col-md-3">
                    <div class="form-group">
                        <label for="quotation_subject">Quotation No <span class="text-danger">*</span></label>
                        <input type="text" name="quotation_no" id="quotation_no" class="form-control" value="<?= $row->quotation_no ?>">
                    </div>
                </div>
                <div class="col-md-3">
                        <div class="form-group">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <label for="quotation_subject">Challan subject <span class="text-danger">*</span></label>
                        <input type="text" name="quotation_subject" id="quotation_subject" class="form-control"  value="<?= $row->quotation_subject; ?>">
                    </div>
            </div>
            </div>
            ...
            <div class="col-md-3">
                    <div class="form-group">
                        <label for="quotation_date">Challan date <span class="text-danger">*</span></label>
                        <input type="text" name="quotation_date" id="quotation_date" class="form-control datepicker-autoclose" value="<?= $this->maahi->date_format($row->quotation_date); ?>">
                    </div>
            </div>
            ...
            <label for="contact_email">Challan status</label>
                <select class="form-control" name="status" id="status" >
                    ...
                    <option <?php if($row->status == 'invoice_pending') { echo "selected"; }  ?> value="invoice_pending">Invoice Pending</option>
                    <option <?php if($row->status == 'invoice_done') { echo "selected"; }  ?> value="invoice_done">Invoice done</option>
                    <option <?php if($row->status == 'temporary') { echo "selected"; }  ?> value="temporary">Temporary</option>
                </select>
            </div>
            </div>
             ...
             <div class="col-md-3" id="invoice_no_ui" style="display: none;">
                <div class="form-group">
                    ...
                    <input type="text" name="invoice_no" id="invoice_no" class="form-control" value="<?=  $row->invoice_no ?>">
                </div>
            </div>
            ...
            <label for="contact_email">Temporary status</label>
                <select class="form-control" name="temporary_status" id="temporary_status" >
                    <option value="">Select status</option>
                    <option <?php if($row->temporary_status == 'given') { echo "selected"; }  ?> value="given">Given</option>
                    <option <?php if($row->temporary_status == 'received') { echo "selected"; }  ?> value="received">Received</option>
                </select>
            </div>
            </div>
                        ...
                        <div class="hide" id="item_service_ui_<?= $randno ?>">
                         ...
                         <div class="hide" id="item_product_ui_<?= $randno ?>">
                              <select data-live-search="true" class="selectpicker form-control" name="item_product[]" id="item_product_<?= $randno ?>" data-style="btn-white" onchange="get_item_price_product(<?= $randno ?>)">
                                <option value="">Select products</option>
                                <?php foreach ($products as $key => $product): ?>
                                    <option data-purchased_price="<?= $product['purchased_price'] ?>" data-pid="<?= $product['id'] ?>" data-price="<?= $product['price'] ?>" value="<?= $product['id'] ?>"><?= $product['product_name'] ?></option>  
                                <?php endforeach ?>    
                            </select>
                         </div>
                    </td>
        ...
        <div class="panel-footer">
            <div class="clearfix">
                <a href="<?= base_url('admin/challan'); ?>"><button type="button" class="btn btn-inverse waves-effect waves-light pull-right" data-dismiss="modal" aria-hidden="true">Close</button></a>
