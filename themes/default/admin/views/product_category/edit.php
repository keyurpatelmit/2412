...
<?php if(canaccess("product_category","edit_access") != 'true'){ echo "<script>window.location.href ='".site_url()."admin'</script>";}?>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="panel panel-color panel-inverse">
                    ...
                    <form method="post"  action='<?= base_url("admin/product_category/edit/{$row->id}"); ?>' enctype="multipart/form-data">
              ...
              <div class="row">
                     ...
                     <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <?php if(!empty($row->img)) { ?>
                              <a class="media_icon" target="_blank" href="<?= base_url() ?>themes/assets/images/product_category/<?= $this->data['row']->img; ?>"><i class="fa fa-picture-o"></i> View Image</a>
                        <?php } ?>
                        </div>
                     </div>
                    ...
                    <div class="panel-footer">
                        <div class="clearfix">
                            ...
                            <a href="<?= base_url('admin/product_category'); ?>"><button type="button" class="btn btn-inverse waves-effect waves-light pull-right" data-dismiss="modal" aria-hidden="true">Close</button></a>
                        </div>
                    </div>
                </form>
                </div>
