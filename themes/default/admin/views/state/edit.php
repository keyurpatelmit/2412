        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="panel panel-color panel-inverse">
                    ...
                    <form name="state_edit" id="state_edit" method="post"  action='<?= base_url("admin/state/edit/{$row->id}"); ?>' enctype="multipart/form-data">
              ...
              <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" required="required" name="state" id="state" class="form-control" placeholder="State" value="<?=  $row->state; ?>">
                        </div>
                    </div>
                    <div class="col-md-12">
