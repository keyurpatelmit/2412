...
<div class="row">
    <div class="col-lg-12">
        <div class="panel panel-color panel-inverse">
            ...
            <form method="post" enctype="multipart/form-data" name="row_add" id="row_add"  action='<?= base_url("admin/puchaseorder/edit/{$row->id}"); ?>'>
            ...
            <div class="row">   
                <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input readonly="" type="text" name="purchase_no" id="purchase_no" class="form-control" value="<?= $row->purchase_no ?>">
                        </div>
                </div>
        ...
        <div class="panel-footer">
            <div class="clearfix">
                ...
                <a href="<?= base_url('admin/puchaseorder'); ?>"><button type="button" class="btn btn-inverse waves-effect waves-light pull-right" data-dismiss="modal" aria-hidden="true">Close</button></a>
            </div>
        </div>
    </form>
    </div>
    ...
    $(document).ready(function() {
        ...
        $('.sa-params-terms').click(function () {
            ...
            swal({
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo site_url('admin/puchaseorder/remove_puchase_order_terms')?>/"+id,
        ...
        $('.sa-params').click(function () {
            ...
            swal({
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo site_url('admin/puchaseorder/remove_items')?>/"+id,
                    success: function(data) {
                        swal({
                            title: 'Deleted!',
                            text: 'Successfully Record deleted.',
