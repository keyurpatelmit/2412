		...
		<div class="row">
	        <div class="col-sm-12">
	            ...
	            <div class="pull-right">
	            	...
	            	<a onclick="formSubmit('excel')" href="<?= base_url("admin/puchaseorder/add_po"); ?>" id="unset_button"><button type="button" id="add" class="btn btn-purple waves-effect waves-light">Add New</button></a>
	            	...
	            	<a href="<?= base_url("admin/puchaseorder"); ?>/unset_session_value" id="unset_button"><button type="button" class="btn btn-primary m-r-5" status="none"><span class="glyphicon glyphicon-refresh"></span></button></a>	
	            </div>
                		...
                		<?php if(!empty($rows)) { ?>
            		  	<?php $count = 1; 
                			...
                			foreach ($rows as $row) : ?>
								...
								<a target="blank" href='<?= base_url("admin/puchaseorder/po_pdf/{$row['id']}"); ?>'><button class="btn btn-icon btn-xs waves-effect waves-light btn-info" data-toggle="tooltip" data-placement="left" title="" data-original-title="<?= lang('puchase order'); ?>"> <i class="fa fa-file-pdf-o"></i> </button></a>
								...
								<?php if(canaccess("puchaseorder","edit_access")){ ?>
								 <a href='<?= base_url("admin/puchaseorder/edit/{$row['id']}"); ?>'><button class="btn btn-icon btn-xs waves-effect waves-light btn-purple" data-toggle="tooltip" data-placement="left" title="" data-original-title="<?= lang('edit'); ?>"> <i class="fa fa-edit"></i> </button></a>
								<?php } ?>
	...
	$(document).ready(function() {
        ...
        $('.sa-params').click(function () {
            ...
            swal({
            	...
            	$.ajax({
            		type: "POST",
            		url: "<?php echo site_url('admin/puchaseorder/row_delete')?>/"+id,
