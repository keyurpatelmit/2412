        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="panel panel-color panel-inverse">
                    ...
                    <form method="post"  action='<?= base_url("admin/uom/edit/{$row->id}"); ?>' enctype="multipart/form-data">
              ...
              <div class="row">
                    ...
                    <div class="panel-footer">
                        <div class="clearfix">
                            ...
                            <a href="<?= base_url('admin/uom'); ?>"><button type="button" class="btn btn-inverse waves-effect waves-light pull-right" data-dismiss="modal" aria-hidden="true">Close</button></a>
                        </div>
                    </div>
                </form>
                </div>
