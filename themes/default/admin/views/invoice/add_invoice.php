...
<?php if(canaccess("invoice","create_access") != 'true'){ echo "<script>window.location.href ='".site_url()."admin'</script>";}?>
        ...
        <div class="panel panel-color panel-inverse">
            ...
            <form method="post" enctype="multipart/form-data" name="row_add" id="row_add">
             <div class="panel-body">
                ...
                <input type="hidden" name="total_margin_amount" id="total_margin_amount">
               <div class="row">   
                <div class="col-md-3">
            ...
            <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" name="invoice_date" id="invoice_date" class="form-control datepicker-autoclose" required="required">
                    </div>
            </div>
                     ...
                     <td>
                        <div class="hide" id="item_service_ui_<?= $randno ?>">
                            <select data-live-search="true" class="selectpicker form-control" name="item_service[]" id="item_service_<?= $randno ?>" data-style="btn-white" onchange="get_item_price_services(<?= $randno ?>)">
                                ...
                                <option data-vendor_id="<?= $service['vendor_id'] ?>"  data-sid="<?= $service['id'] ?>" data-gst="<?= $service['gst'] ?>" data-price="<?= $service['price'] ?>" value="<?= $service['id'] ?>"><?= $service['title'] ?></option>  
                                <?php endforeach ?>     
                            </select>
                        </div>
                         ...
                         <div class="hide" id="item_product_ui_<?= $randno ?>">
                              <select data-live-search="true" class="selectpicker form-control" name="item_product[]" id="item_product_<?= $randno ?>" data-style="btn-white" onchange="get_item_price_product(<?= $randno ?>)">
                                ...
                                <option data-vendor_id="<?= $product['vendor_id'] ?>" data-gst="<?= $product['gst'] ?>" data-pid="<?= $product['id'] ?>" data-price="<?= $product['price'] ?>" value="<?= $product['id'] ?>"><?= $product['product_name'] ?> </option>  
                                <?php endforeach ?>     
                            </select>
                         </div>
                    </td>
...
<div class="row">
    <div class="col-md-6" id="header_ui">
        <h3>Activity to be done by support department</h3>  
    </div>
</div>
       ...
       <script type="text/javascript">
        ...
        function get_terms_condtion() {
            tinyMCE.activeEditor.setContent(s);
            $('#term_condition_txt').val('hello');
        }
...
function add_inquiry_item()
{
    ...
    $('#inquiry_list_ui').append('<tr id="forcontactrow">'+
            ...
            '<td><input type="text" name="item_qty[]" id="item_qty_'+randno+'" class="form-control "></td>'+
...
{
    var randno = Math.floor((Math.random() * 999999) + 111111);
    $('#support_list_ui').append('<tr id="forcontactrow">'+
        ...
        /*function get_item_total(randno) {
            ...
            if(selected_price != '' || selected_purchase_item_price != ''){
                ...
                $("#margin_item_price_"+randno).val(margin_total);
            }
            findl_total();
        }*/
