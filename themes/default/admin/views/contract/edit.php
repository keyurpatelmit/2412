        ...
        <div class="row">
            <div class="col-lg-12"> 
                <div class="panel panel-color panel-inverse">
                    ...
                    <form name="customer_edit" id="customer_edit" method="post"  action='<?= base_url("admin/contract/edit/{$row->id}"); ?>' enctype="multipart/form-data">
                  ...
                  <div class="col-md-3">
                    ...
                    <div class="panel-footer">
                        <a href="<?= base_url('admin/contract'); ?>"><button type="button" class="btn btn-inverse waves-effect waves-light pull-right" data-dismiss="modal" aria-hidden="true">Close</button></a>
    ...
    $(document).ready(function() {
        ...
        $('.sa-params-contact').click(function () {
            ...
            swal({
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo site_url('admin/contract/vendor_contact_delete')?>/"+id,
