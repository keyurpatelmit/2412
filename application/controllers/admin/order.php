...
class Order extends MY_Controller {
    ...
    public function index() {
        ...
        $meta['page_title'] = 'Order';
        
        $this->page_construct('order/view', $meta, $this->data);
    }
     ...
     public function add_po() 
    {
        ...
        $this->page_construct('order/add_po', $meta, $this->data);
    }
    ...
    public function add_row() 
    {
     ...
     public function edit($id) {
        ...
        if($_POST && $_POST['id'] != '') {
            ...
            $this->page_construct('order/edit',$meta, $this->data);
        }
    }
    ...
    function get_vendor()
    {
        ...
        $html = $this->load->view('/admin/views/order/vendor',$this->data,true);  
